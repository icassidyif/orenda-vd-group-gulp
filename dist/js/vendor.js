...
/*!*************************************************************!*\
  !*** ./node_modules/unique-names-generator/dist/index.m.js ***!
  \*************************************************************/
/*! exports provided: NumberDictionary, adjectives, animals, colors, countries, languages, names, starWars, uniqueNamesGenerator */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NumberDictionary", function() { return y; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "adjectives", function() { return n; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animals", function() { return l; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colors", function() { return r; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countries", function() { return t; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "languages", function() { return o; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "names", function() { return s; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "starWars", function() { return d; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "uniqueNamesGenerator", function() { return i; });
...
var Modals = /*#__PURE__*/function () {
  function Modals() {
    var _props$queueMode, _props$lockScroll, _props$openWithLink;
    ...
    this.queueMode = (_props$queueMode = props.queueMode) !== null && _props$queueMode !== void 0 ? _props$queueMode : false;
    this.lockScroll = (_props$lockScroll = props.lockScroll) !== null && _props$lockScroll !== void 0 ? _props$lockScroll : true;
    this.openWithLink = (_props$openWithLink = props.openWithLink) !== null && _props$openWithLink !== void 0 ? _props$openWithLink : false;
    this.overlay = _classStaticPrivateMethodGet(_this$constructor = this['constructor'], Modals, _createOverlay).call(_this$constructor);
    this.updateModals();
    ...
    var handleClick = _classStaticPrivateMethodGet(this['constructor'], Modals, _handleClick).bind(this);
  ...
  _createClass(Modals, [{
    ...
    value: function open(id) {
      var _this$openHandlers,
          _this = this;

      var modal = this.getModal(id);
      if (!modal) throw new Error("no modal found with id '".concat(id, "'"));
      ...
      var locked = document.body.classList.contains('_modal');

      if (this.lockScroll && !locked) {
        var _this$constructor2;

        _classStaticPrivateMethodGet(_this$constructor2 = this['constructor'], Modals, _manageScroll).call(_this$constructor2);

        this.overlay.classList.add('_active');
      }

      if ((_this$openHandlers = this.openHandlers) !== null && _this$openHandlers !== void 0 && _this$openHandlers[id]) {
        this.openHandlers[id].forEach(function (callback) {
          callback(_this.getModal(id));
        });
      }
    }
  }, {
    ...
    value: function close() {
      var _this$closeHandlers,
          _this2 = this;

      var modal = this.activeModal;
      if (!modal) throw new Error("no modal found with id '".concat(modal.id, "'"));
      modal.element.classList.remove('_active');
      this.activeModal = null;

      if ((_this$closeHandlers = this.closeHandlers) !== null && _this$closeHandlers !== void 0 && _this$closeHandlers[modal.id]) {
        this.closeHandlers[modal.id].forEach(function (callback) {
          callback(_this2.getModal(modal.id));
        });
      }
      ...
      if (this.lockScroll && !this.activeModal) {
        ...
        _classStaticPrivateMethodGet(_this$constructor3 = this['constructor'], Modals, _waitForAction).call(_this$constructor3, modal.element.querySelector('[data-modal-content]'), function () {
          var _this$constructor4;

          return _classStaticPrivateMethodGet(_this$constructor4 = _this2['constructor'], Modals, _manageScroll).call(_this$constructor4);
        });
    ...
    value: function toggle(id) {
      var modal = this.getModal(id);
      if (!modal) throw new Error("no modal found with id '".concat(id, "'"));
      this.bufferedModals.includes(modal) || this.activeModal === modal ? this.close(modal.id) : this.open(modal.id);
    }
  }, {
    key: "closeAll",
    ...
    key: "updateModals",
    value: function updateModals() {
      var _this$constructor5;

      var modals = _toConsumableArray(document.querySelectorAll('[data-modal-content]'));

      this.modals = _classStaticPrivateMethodGet(_this$constructor5 = this['constructor'], Modals, _generateStructure).call(_this$constructor5, modals);
      this.activeModal = null;
      this.bufferedModals = [];
    }
  }, {
    ...
    value: function getModal(id) {
      return this.modals.find(function (modal) {
        return modal.id === id;
      });
    }
  }, {
    ...
    value: function getLink(id) {
      var link = window.location.href.replace(/window.location.hash/, '').replace(/\/$/, '');
      return "".concat(link, "#modal:").concat(id);
    }
  }, {
    key: "onOpen",
    value: function onOpen(id, callbackArr) {
      if (!this.openHandlers) this.openHandlers = {};
      this.openHandlers[id] = callbackArr;
    }
  }, {
    key: "onClose",
    value: function onClose(id, callbackArr) {
    ...
    value: function removeFromQueue(id) {
      ...
      var modal = this.getModal(id);
      var index = this.bufferedModals.indexOf(modal);
...
function _handleClick(event) {
  ...
  var closest = function closest(s) {
    return event.target.closest(s);
  };

  var openBtn = closest('[data-modal-open]');
  var closeBtn = closest('[data-modal-close]');
  var clickOutside = closest('[data-modal-body]') && !closest('[data-modal-content]');
  if (!openBtn && !closeBtn && !clickOutside) return;
  event.preventDefault();
  if (!_classStaticPrivateFieldSpecGet(this['constructor'], Modals, _allowAction)) return;

  _classStaticPrivateFieldSpecSet(this['constructor'], Modals, _allowAction, false);
  ...
  if (closeBtn) {
    var closestModal = closest('[data-modal-content]');
    id = closeBtn.dataset.modalClose || (closestModal === null || closestModal === void 0 ? void 0 : closestModal.id);
  ...
  var modal = getModal.call(this, id);

  _classStaticPrivateMethodGet(_this$constructor6 = this['constructor'], Modals, _waitForAction).call(_this$constructor6, modal.element.querySelector('[data-modal-content]'), function () {
    return _classStaticPrivateFieldSpecSet(_this3['constructor'], Modals, _allowAction, true);
  });
}

function _generateStructure(modals) {
...
function _manageScroll() {
  var hasStyle = document.body.style.paddingRight;
  if (hasStyle) document.body.style.paddingRight = '';else {
    var scroll = window.innerWidth;
    var noScroll = document.body.offsetWidth;
    var scrollWidth = scroll - noScroll;
    document.body.style.paddingRight = scrollWidth + 'px';
  }
  document.body.classList.toggle('_modal');
}

function _waitForAction(element, callback) {
  var styles = window.getComputedStyle(element);
  var duration = styles.getPropertyValue('transition-duration');
  ...
  (function () {
      ...
      for (var _i3 = 0; _i3 < moveElementsInfo.length; _i3++) {
        ...
        if (_breakpoint2.matches) {
          if (!_element2.classList.contains(className)) {
            ...
            } else if (_place === 'first') {
              _destination.prepend(_element2);
            } else if (_destination.children[_place - 1]) {
    ...
    for (var i = 0; i < moveElements.length; i++) {
      ...
      if (moveAttr) {
        ...
        var place = moveArr[2] ? moveArr[2].trim() : 1;
...
function handleTouchMove(evt) {
  ...
  if (Math.abs(xDiff) > Math.abs(yDiff)) {
    if (xDiff > 0) {
      onSwipe.right.forEach(function (cb) {
        return cb();
      });
    } else {
      onSwipe.left.forEach(function (cb) {
        return cb();
      });
    }
  } else if (yDiff > 0) {
    onSwipe.down.forEach(function (cb) {
      return cb();
    });
  } else {
    onSwipe.up.forEach(function (cb) {
      return cb();
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (onSwipe);

/***/ }),

/***/ "./src/js/vendor/testWebp.js":
/*!***********************************!*\
  !*** ./src/js/vendor/testWebp.js ***!
  \***********************************/
/*! no static exports found */
...
var testWebp = function testWebp(cb) {
  var webp = new Image();

  webp.onload = function () {
    return cb(webp.height === 2);
  };
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_reflect_has_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.reflect.has.js */ "./node_modules/core-js/modules/es.reflect.has.js");
/* harmony import */ var core_js_modules_es_reflect_has_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_reflect_has_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modals */ "./src/js/vendor/modals.js");
/* harmony import */ var _blocks_modules_header_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../blocks/modules/header/header */ "./src/blocks/modules/header/header.js");
/* harmony import */ var _blocks_modules_apartments_apartments__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../blocks/modules/apartments/apartments */ "./src/blocks/modules/apartments/apartments.js");





var modals = new _modals__WEBPACK_IMPORTED_MODULE_2__["default"]();
var header = new _blocks_modules_header_header__WEBPACK_IMPORTED_MODULE_3__["default"]();
document.addEventListener('DOMContentLoaded', function () {
  var forms = document.querySelectorAll('form._validate');
  ...
  var _loop = function _loop(i) {
    ...
    function formSubmit(evt) {
      ...
      controlApp({
        ...
        modals: modals,
        header: header,
        sliders: _blocks_modules_apartments_apartments__WEBPACK_IMPORTED_MODULE_4__["default"]
      });
      return false;
    }
